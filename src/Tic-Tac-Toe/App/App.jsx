...
export default function App() {
  ...
  const resetButton = !gameOver ? null : <Reset gameOver={gameOver} setGameOver={setGameOver} boardState={boardState} setBoardState={setBoardState} currentPlayer={currentPlayer} setCurrentPlayer={setCurrentPlayer}/>
